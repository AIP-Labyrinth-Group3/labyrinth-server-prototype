...
public class SocketConnectionHandlerBroadcast extends TextWebSocketHandler {
    private final SocketBroadcastService socketBroadcastService;

    public SocketConnectionHandlerBroadcast(SocketBroadcastService socketBroadcastService) {
